...
def get_customers(search_criterion, search_value):
    ...
    full_server_url = (
        "http://localhost:5292/Customer/?searchCriterion=" + search_criterion +
    ...
    if r.status_code == 200:
        ...
        return f"Failure to find any customers with {search_criterion} " \
               f"{search_value}."
...
functions = [
    {
        "name": "get_customers",
        "description": "Get a list of customers based on a search criterion "
                       "and value.",
        "parameters": {
            "type": "object",
            "properties": {
